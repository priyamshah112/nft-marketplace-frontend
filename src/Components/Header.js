...
const Header = () => {
    ...
    return (
        <div>
            ...
            <div className="flex text-2xl flex-col w-full mb-8 bg-cover bg-no-repeat" style={{minHeight:'500px',backgroundImage:"url('https://cdn.shopify.com/s/files/1/1414/2472/articles/46_1300x800.png?v=1593590858')",boxShadow:"inset 0 0 0 1000px rgb(0 0 0 / 33%)"}}>
